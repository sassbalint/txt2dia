...
20260614:
	make process I="$T/jojj_itt_az_ido.txt $T/uram_irgalmazz_augustin.txt $T/tied_a_dicsoseg.txt $T/szentlelek_jojj.txt $T/alleluja_augustin.txt $T/hiszekegy.txt $T/kenyered_es_borod.txt $T/szent_vagy_augustin.txt $T/isten_baranya_augustin.txt $T/hivlak_jezus.txt $T/anima_christi.txt $T/indulj_es_menj.txt $T/aldasoddal_megyunk.txt" O=outs/20260614.dia

20260524:
	make process I="$T/oltarodhoz_jottem_en.txt $T/im_ma_az_egesz_egbolt.txt $T/uram_irgalmazz_augustin.txt $T/dicsoseg_sillye_iii.txt $T/szentlelek_jojj.txt $T/alleluja_augustin.txt $T/hiszekegy.txt $T/fogadd_tolunk_egi_atyank.txt $T/szent_vagy_augustin.txt $T/isten_baranya_augustin.txt $T/lelkem_aldd_az_urat.txt $T/magasztaljon_teged.txt $T/szepseges_jezus.txt $T/szentlelek_ugy_kerunk.txt" O=outs/20260524.dia
...
20260215:
	make process I="$T/halld_hogy_zug_a_ret.txt $T/uram_irgalmazz_sillye.txt $T/dicsoseg_sillye_iii.txt $T/jojjetek_aldjuk_az_isten_nevet.txt $T/lelkem_az_urat_dicserd.txt $T/tobb_erot.txt $T/szent_vagy_sillye.txt $T/isten_baranya_sillye.txt $T/napfiver_holdnover.txt $T/jezus_aldott_legyel.txt $T/ez_az_a_nap.txt" O=outs/20260215.dia

20260118:
	make process I="$T/szent_szent_a_neve.txt $T/uram_irgalmazz_sillye.txt $T/dicsoseg_sillye_iii.txt $T/beke_istene.txt $T/zengd_velunk.txt $T/kenyered_es_borod.txt $T/szent_vagy_sillye.txt $T/isten_baranya_sillye.txt $T/hivlak_jezus.txt $T/izleld_es_lasd.txt $T/indulj_es_menj.txt" O=outs/20260118.dia

20251221:
	make process I="$T/_szentev.txt $T/advent_sotet_fenn.txt $T/uram_irgalmazz_augustin.txt $T/04_ropke_fohasz.txt $T/ebredj_ember.txt $T/benned_bizom.txt $T/szent_vagy_augustin.txt $T/isten_baranya_augustin.txt $T/a_szeleknek.txt $T/gabriels_message.txt $T/csak_jezusnak.txt $T/o_jojj_o_jojj.txt $T/_szentev.txt" O=outs/20251221.dia

20251116:
	make process I="$T/_szentev.txt $T/szent_marton.txt $T/uram_irgalmazz_augustin.txt $T/tied_a_dicsoseg.txt $T/ebredj_fel_te_ki.txt $T/alleluja_augustin.txt $T/taplalo_szent_kenyer.txt $T/szent_vagy_augustin.txt $T/isten_baranya_augustin.txt $T/nincs_mas_isten.txt $T/neked_hodolok.txt $T/camino.txt $T/_szentev.txt" O=outs/20251116.dia

20251019:
	make process I="$T/_szentev.txt $T/zarandokenek.txt $T/uram_irgalmazz_augustin.txt $T/tied_a_dicsoseg.txt $T/benned_bizom.txt $T/alleluja_augustin.txt $T/annak_ki_a_tronon_ul.txt $T/szent_vagy_augustin.txt $T/isten_baranya_augustin.txt $T/te_vagy_az_ut.txt $T/tobb_erot.txt $T/indulj_es_menj.txt $T/_szentev.txt" O=outs/20251019.dia
